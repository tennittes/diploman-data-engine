...
def update_hero_status(image_src, target_url="https://www.diplomantimes.com/p/daily-performance-table.html"):
    ...
    print("hero-status.json successfully updated with live pulsing indicators.")
